                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('sellers.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" name="name" placeholder="Ex.: Mauricio">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input required type="email" class="form-control" name="email" placeholder="Ex.: john@gmail.com">
                        </div>
                        <div class="form-group">
                            <label for="phone">Telefone</label>
                            <input required type="text" class="form-control phone" name="phone" placeholder="Ex.: (11) 99999-9999">
                        </div>
                        <div class="form-group">
